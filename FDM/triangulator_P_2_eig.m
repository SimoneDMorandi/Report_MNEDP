function [geom] = triangulator_P_2_eig(area_ref, marker_triang)
  % Uguale al triangolatore per i P2, ma con condizioni di Dirichlet per gli autovalori
    ...
    BC.Values = [0.0 11.0 0.0 13.0 0.0 15.0 0.0 0.0 0.0]; % Condizioni di Neumann: 12, 14, 16, 0
