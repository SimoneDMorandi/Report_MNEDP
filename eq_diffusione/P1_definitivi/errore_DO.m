function [err_LInf, err_L2, err_H1] = errore_DO(u_esatta, u_star, geom, gN, u0)
...
errore = zeros(geom.Nobj.N_node,1);
for n = 1: geom.Nobj.N_node
    errore(n) = abs(u_star(n) - u_esatta(geom.obj.P(n,1),geom.obj.P(n,2)));
end
err_LInf = max(errore);
